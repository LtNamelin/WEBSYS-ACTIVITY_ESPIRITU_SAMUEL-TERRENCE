    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="hidden menu-item"><a href="#">Home</a></li>
                <li class="hidden menu-item"><a href="https://codeigniter.com/user_guide/" target="_blank">Docs</a>
                </li>
                <li class="hidden menu-item"><a href="https://forum.codeigniter.com/" target="_blank">Community</a></li>
                <li class="hidden menu-item"><a
